...
class CampaignController extends Controller
{
    ...
    public function update(Request $request, Campaign $campaign)
    {
        ...
        $old = $campaign->only(['title', 'status', 'is_featured', 'meta_title', 'meta_description', 'meta_keywords']);
        $campaign->update($validated);
        $new = $campaign->only(['title', 'status', 'is_featured', 'meta_title', 'meta_description', 'meta_keywords']);

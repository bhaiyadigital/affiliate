<?php $__env->startSection('meta'); ?>
    <?php echo $__env->make('components.meta-info.add-meta.campaign-details-meta', ['setup' => $setup], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="container mx-auto py-6 lg:py-10 px-4 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div class="space-y-7">
                ...
                <!-- Legal Link -->
                <a href="#" class="text-[#757575] text-sm underline hover:text-[#0071c5] block">See legal
                    disclaimers</a>

                <!-- Download Campaign Guide (Dynamic File Link) -->
                <a href="<?php echo e(route('drive.file.stream', ['type' => 'campaign', 'id' => $campaign->id])); ?>" target="_blank"
                    class="flex items-center gap-4 py-2 group cursor-pointer border-none bg-transparent">
                    <div
                        class="w-12 h-12 border-[1.5px] border-[#0071c5] flex items-center justify-center rounded-sm group-hover:bg-blue-50 transition-colors shrink-0">
                ...
                <div class="pt-4">
                    <div class="flex items-center gap-4">
                        <div class="relative w-[280px] border border-[#0071c5] flex items-center cursor-pointer">
                            <div
                                class="flex-1 px-4 py-2.5 text-[#0071c5] font-bold text-sm border-r border-[#0071c5] uppercase">
                        ...
                        <button onclick="openGlobalShareModal(window.location.href, 'Check out this Campaign')"
                            class="bg-[#0071c5] text-white px-8 py-2.5 flex items-center gap-3 font-bold text-[15px] hover:bg-[#005ea3] transition-all">
...
<?php echo $__env->make('frontend.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\frontend\campaignDetails.blade.php ENDPATH**/ ?>
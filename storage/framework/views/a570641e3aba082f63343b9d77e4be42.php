...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <span class="badge">New <?php echo e($type); ?></span>
            <h1><?php echo e($title); ?></h1>
            <p><?php echo e($body); ?></p>
            <a href="<?php echo e($url); ?>" class="btn">View <?php echo e($type); ?></a>
        </div>
        <div class="footer">
            You received this email because you are a registered partner. &copy; <?php echo e(date('Y')); ?> Bhaiya Asset Library.
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\affiliate\resources\views\emails\new-content.blade.php ENDPATH**/ ?>
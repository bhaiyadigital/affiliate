...
<head>
   ...
   <?php if (! empty(trim($__env->yieldContent('meta')))): ?>
    ...
    <?php else: ?>
        <title><?php echo e($setup->site_name ?? 'Bhaiya Asset Library'); ?></title>
        <meta name="description" content="<?php echo e($setup->meta_description ?? 'Explore our Assets'); ?>">
    <?php endif; ?>
    <!-- Favicon -->
...
<?php /**PATH C:\laragon\www\affiliate-project\resources\views/frontend/layouts/front.blade.php ENDPATH**/ ?>
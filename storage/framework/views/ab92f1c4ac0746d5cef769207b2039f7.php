                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <div class="flex flex-col">
                                        <span
                                            class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($lead->name); ?></span>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    ?>
                                    <span
                                        class="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase <?php echo e($colorClass); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views/leads/index.blade.php ENDPATH**/ ?>
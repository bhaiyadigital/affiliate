<?php $__env->startSection('content'); ?>
    <div class="p-4 mx-auto w-full md:p-6" x-data="{
        ...
        <div class="flex flex-col gap-4 mb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white capitalize">
                    <?php echo e(str_replace(['-', '_'], ' ', $module)); ?> List
                </h1>
        ...
        <div x-show="selected.length > 0" x-cloak
            ...
            <form id="bulk-form" action="<?php echo e(route('contents.bulk', $module)); ?>" method="POST"
                            ...
                            <?php $__currentLoopData = $config; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($data['show_in_table']) && $field !== 'module_name'): ?>
                                    <th class="px-5 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">
                                        <?php echo e($field === 'parent_id' || $field === 'destination_id' ? 'Parent' : $data['label']); ?>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800" id="sortable-rows">
                        <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-id="<?php echo e($item->id); ?>" class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-5 py-4">
                                    <input type="checkbox" value="<?php echo e($item->id); ?>" x-model="selected" @change="updateCheckAll()"
                                        class="row-check">
                                </td>
                                        ...
                                        <td class="px-5 py-4">
                                            ...
                                            <?php if(($data['type'] ?? '') == 'image'): ?>
                                                <?php if($item->imageUrl): ?>
                                                    <div class="h-10 w-14 rounded border border-gray-100 overflow-hidden bg-gray-50 shadow-sm">
                                                        <img src="<?php echo e(!empty($item->image) ? $item->imageUrl : 'https://ui-avatars.com/api/?name=' . urlencode($item->title) . '&background=3b82f6&color=fff'); ?>"
                                                            class="w-full h-full object-cover" alt="<?php echo e($item->title); ?>">
                                                    </div>
                                                <?php else: ?>
                                            ...
                                            <?php elseif($field == 'name'): ?>
                                                <?php if($module === 'coupons'): ?>
                                                    <span class="text-sm font-medium text-gray-800 px-2 py-1 rounded"><?php echo e($item->$field); ?>
                                            ...
                                            <?php elseif($field == 'used_count'): ?>
                                                <div class="flex flex-col">
                                                    <span class="text-sm font-black text-blue-600"><?php echo e($item->used_count); ?></span>
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <?php if($module === 'project'): ?>
                                            <a href="<?php echo e(route('affiliated.project.details', $item->slug)); ?>" target="_blank"
                                        ...
                                        <?php if($isTrashed): ?>
                                            ...
                                            <form action="<?php echo e(route('contents.restore', [$module, $item->id])); ?>" method="POST"
                                                class="inline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate-project\resources\views/contents/index.blade.php ENDPATH**/ ?>
...
<div class="relative" x-data="{
    ...
    <div
        ...
        class="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-xl border border-gray-100 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
        style="display: none;"
    >
        <!-- Dropdown Header -->
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\components\header\notification-dropdown.blade.php ENDPATH**/ ?>
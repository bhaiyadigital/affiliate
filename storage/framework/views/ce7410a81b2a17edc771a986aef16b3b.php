...
<div class="p-4 mx-auto max-w-screen-md md:p-6">
    ...
    <textarea
        ...
        class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 dark:border-gray-700 dark:text-white/90 focus:border-blue-500 focus:outline-none"
    ><?php echo e(old('remarks', $lead->remarks)); ?></textarea>

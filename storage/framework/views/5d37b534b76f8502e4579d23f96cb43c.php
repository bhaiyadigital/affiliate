...
<div class="p-4 mx-auto w-full  md:p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Add a new system user</p>
    </div>
    <form action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <?php echo $__env->make('users._form', ['roles' => $roles, 'assignedRoles' => []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\users\create.blade.php ENDPATH**/ ?>
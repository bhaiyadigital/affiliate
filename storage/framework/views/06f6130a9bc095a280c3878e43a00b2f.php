                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700" 
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors cursor-move group" 
                                    draggable="true"
                                    @dragstart="handleDragStart($event, <?php echo e($asset->id); ?>)"
                                    @dragend="handleDragEnd($event)"
                                    @dragover.prevent="handleDragOver($event)"
                                    data-asset-id="<?php echo e($asset->id); ?>"
                                    x-ref="row_<?php echo e($asset->id); ?>">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($asset->title); ?></p>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($asset->project->name); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($asset->media->count()); ?> file(s)</span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <?php if($asset->file_path): ?>
                                            <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($asset->file_size_formatted); ?></span>
                                        <?php else: ?>
                                            <span class="text-gray-300 dark:text-gray-600">—</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($asset->getTotalDownloadsAttribute()); ?></span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
        ...
        function dragDropSort() {
            return {
                ...
                updateSortOrder() {
                    ...
                    fetch('<?php echo e(route("assets.sort")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\assets\index.blade.php ENDPATH**/ ?>
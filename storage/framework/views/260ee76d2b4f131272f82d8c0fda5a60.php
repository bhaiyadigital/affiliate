<div x-data="{saveProfile(){
    ...
    <div class="p-5 mb-6 border border-gray-200 rounded-xl dark:border-gray-800 lg:p-6">
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\components\profile\personal-info-card.blade.php ENDPATH**/ ?>
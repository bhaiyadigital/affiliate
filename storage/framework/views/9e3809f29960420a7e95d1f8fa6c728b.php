...
@click.away="isOpen = false">
    ...
    <div class="z-50 fixed" x-ref="content">
        <div x-show="isOpen" x-cloak class="p-2 bg-white border border-gray-200 rounded-xl shadow-lg dark:border-gray-800 dark:bg-gray-dark w-40">
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\components\common\table-dropdown.blade.php ENDPATH**/ ?>
        ...
        <div class="container mx-auto px-4 md:px-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div class="lg:col-span-8 flex flex-col h-full ">
                    ...
                    <div class="relative w-full rounded overflow-hidden group cursor-pointer bg-gray-100 h-full"
                        ...
                        <img src="<?php echo e($displayImage); ?>" alt="<?php echo e($project->title ?? 'Project Image'); ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function checkCoupon(code) {
            ...
            fetch("<?php echo e(route('coupon.check')); ?>", {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('frontend.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views/frontend/landing/projectDetails.blade.php ENDPATH**/ ?>
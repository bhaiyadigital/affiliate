...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                <span
                    class="absolute top-1/2 left-0 -translate-y-1/2 border-r border-gray-200 px-3.5 dark:border-gray-800 text-gray-500">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
                            d="M3 4a1 1 0 000 2h1v8H3a1 1 0 100 2h14a1 1 0 100-2h-1V6h1a1 1 0 100-2H3zm3 2h2v8H6V6zm4 0h4v8h-4V6z"
                            fill="#667085" />
                    </svg>
                </span>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="slug" id="slug"
                    value="<?php echo e(old('slug', $isEdit ? $campaign->slug : '')); ?>" placeholder="eid-special-offer-2025"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div x-data="{
                ...
                <div @click="$refs.thumbnailInput.click()" @dragover.prevent
                    ...
                    <template x-if="!preview">
                        <div class="flex flex-col items-center gap-2 py-4 text-center">
                            <div
                                class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center dark:bg-blue-900/30">
                                <svg class="text-blue-500" width="20" height="20" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Click or drag image here
                                </p>
                ...
                <input type="file" id="thumbnail_input" x-ref="thumbnailInput" name="thumbnail" accept="image/*"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.drive-upload','data' => ['fieldName' => 'drive_file_id','fileId' => old(
                    'drive_file_id',
                    $isEdit && $campaign->file ? str_replace('drive:', '', $campaign->file) : '',
...
<?php endif; ?>
<?php $component->withAttributes(['field-name' => 'drive_file_id','file-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old(
                    'drive_file_id',
                    $isEdit && $campaign->file ? str_replace('drive:', '', $campaign->file) : '',
                ))]); ?>
        ...
        <div
            ...
            <div>
                ...
                <select name="project_id" required
                    class="shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 <?php $__errorArgs = ['project_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($project->id); ?>"
                            <?php echo e(old('project_id', $isEdit ? $campaign->project_id : '') == $project->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    <option value="draft"
                        <?php echo e(old('status', $isEdit ? $campaign->status : 'draft') === 'draft' ? 'selected' : ''); ?>>
                        Draft</option>
                    <option value="active"
                        <?php echo e(old('status', $isEdit ? $campaign->status : '') === 'active' ? 'selected' : ''); ?>>
                        Active</option>
                    <option value="expired"
                        <?php echo e(old('status', $isEdit ? $campaign->status : '') === 'expired' ? 'selected' : ''); ?>>
                        Expired</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="rounded-xl border border-gray-100 bg-gray-50/50 p-4 dark:border-gray-700 dark:bg-gray-800/40">
            ...
            <div class="space-y-2">
                <label
                    class="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-3 cursor-pointer hover:border-blue-300 dark:border-gray-700 dark:bg-gray-800 transition-colors has-[:checked]:border-blue-400 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20 dark:has-[:checked]:border-blue-700">
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\campaigns\_form.blade.php ENDPATH**/ ?>
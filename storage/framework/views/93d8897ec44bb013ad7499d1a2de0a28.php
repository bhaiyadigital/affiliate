        ...
        <div x-show="accountDrawer" class="fixed inset-0 z-[100] lg:hidden" style="display: none;">
            ...
            <div x-show="accountDrawer" x-transition:enter="transition ease-out duration-300"
                ...
                <nav class="flex flex-col overflow-y-auto pt-2">
                    ...
                    <a href="<?php echo e(route('profile.leads')); ?>"
                        class="flex items-center gap-3 px-6 py-4 border-b border-gray-50 text-left transition-colors <?php echo e(request()->routeIs('profile.leads') ? 'bg-[#003B7A] text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                        <i class="fa-solid fa-users-rectangle w-5"></i>
                        <span class="text-sm font-medium">My Leads</span>
                    </a>

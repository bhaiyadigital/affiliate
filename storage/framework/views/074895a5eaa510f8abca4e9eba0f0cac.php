    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div>
            ...
            <input type="text" name="title" id="title" required
                value="<?php echo e(old('title', $isEdit ? $asset->title : '')); ?>" placeholder="e.g. Static Banners:"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="slug" id="slug" value="<?php echo e(old('slug', $isEdit ? $asset->slug : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <div class="text-gray-900 dark:text-white">
                ...
                <textarea name="description" id="asset-description"><?php echo old('description', $isEdit ? $asset->description : ''); ?></textarea>
            </div>
            ...
            <?php if($isEdit && $asset->media->count()): ?>
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-3">
                    <?php $__currentLoopData = $asset->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div id="media-<?php echo e($media->id); ?>"
                            ...
                            <?php endif; ?>
                            <button type="button" @click="markDelete('<?php echo e($media->id); ?>')"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="asset_id_code"
                    value="<?php echo e(old('asset_id_code', $isEdit ? $asset->asset_id_code : '')); ?>" placeholder="AS6748EN"
                    class="shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
            </div>
...
unset($__errorArgs, $__bag); ?>">
                    <option value="active"
                        <?php echo e(old('status', $isEdit ? $asset->status : 'active') === 'active' ? 'selected' : ''); ?>>
                        Active</option>
                    <option value="draft"
                        <?php echo e(old('status', $isEdit ? $asset->status : '') === 'draft' ? 'selected' : ''); ?>>Draft
                    </option>
                    <option value="expired"
                        <?php echo e(old('status', $isEdit ? $asset->status : '') === 'expired' ? 'selected' : ''); ?>>
                        Expired</option>
                </select>
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\assets\_form.blade.php ENDPATH**/ ?>
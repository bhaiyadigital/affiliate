...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['items' => ['View More','Delete']]));
...
foreach (array_filter((['items' => ['View More','Delete']]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="{openDropDown: false}" class="relative h-fit">
    ...
    <div x-show="openDropDown" @click.outside="openDropDown = false" 
         class="absolute right-0 z-40 w-40 p-2 space-y-1 bg-white border border-gray-200 shadow-theme-lg dark:bg-gray-dark top-full rounded-xl dark:border-gray-800">
...
</div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\common\dropdown-menu.blade.php ENDPATH**/ ?>
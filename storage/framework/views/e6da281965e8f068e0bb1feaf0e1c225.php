<div x-data="{
    ...
    <div class="overflow-hidden rounded-xl border border-gray-100 bg-white pt-4 dark:border-white/[0.05] dark:bg-white/[0.03]">
        <!-- Header -->
...
</div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\tables\basic-tables\basic-tables-two.blade.php ENDPATH**/ ?>
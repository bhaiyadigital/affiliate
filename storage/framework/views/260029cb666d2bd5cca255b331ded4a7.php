<?php $__env->startSection('content'); ?>
    <style>
        :root {
            ...
            --custom-gradient: linear-gradient(135deg, #012d20 0%, #065e43 100%) !important;
        ...
        .auth-page {
            ...
            padding: 40px 20px;
            background-color: linear-gradient(135deg, #012d20 0%, #065e43 100%) !important;
        }
    ...
    <div class="auth-page">
        <div class="auth-shell" data-lenis-prevent>
          ...
          <p class="auth-desc">
    আপনার <b><?php echo e(session('verify_email')); ?></b> ঠিকানায় সিকিউরিটি কোড পাঠানো হয়েছে। অনুগ্রহ করে ১ মিনিট অপেক্ষা করুন, ১ মিনিটের মধ্যে আপনার ইমেইলে OTP পৌঁছে যাবে।
</p>

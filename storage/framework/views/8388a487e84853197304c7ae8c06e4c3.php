<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    <div
      class="rounded-xl border border-gray-100 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6"
    >
      <div
  ...
  </div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\ecommerce\ecommerce-metrics.blade.php ENDPATH**/ ?>
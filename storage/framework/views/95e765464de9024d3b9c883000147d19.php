<?php $__env->startSection('content'); ?>
    <div class="p-4 mx-auto w-full  md:p-6">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Create Campaign</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the details below to launch a new campaign</p>
        </div>

        
        <form action="<?php echo e(route('campaigns.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <div class="rounded-xl border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                <?php echo $__env->make('campaigns._form', ['projects' => $projects], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\campaigns\create.blade.php ENDPATH**/ ?>
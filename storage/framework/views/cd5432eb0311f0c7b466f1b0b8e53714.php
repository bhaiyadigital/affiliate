...
<div class="rounded-xl border p-4 <?php echo e($containerClass); ?>">
    <div class="flex items-start gap-3">
        <div class="-mt-0.5 <?php echo e($iconClass); ?>">
            <?php echo $icon; ?>
        ...
        <div class="flex-1">
            ...
            <?php if($message): ?>
                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($message); ?></p>
            <?php endif; ?>

            <?php if($showLink): ?>
                <a 
                    href="<?php echo e($linkHref); ?>" 
...
</div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\ui\alert.blade.php ENDPATH**/ ?>
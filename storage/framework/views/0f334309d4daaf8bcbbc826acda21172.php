<form action="<?php echo e(route('profile.index')); ?>" method="GET" class="mb-6 flex flex-wrap gap-4 items-end  p-4">
    ...
    <a href="<?php echo e(route('profile.index')); ?>?active_tab=leads" class="bg-gray-200 px-4 py-2 rounded text-sm">Reset</a>
</form>
<!-- Stats Grid -->
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
    <div class="p-4 bg-blue-50 border border-blue-100 rounded-sm">
        ...
        <div class="text-2xl font-bold text-blue-900"><?php echo e($leads->where('user_id', auth()->id())->count()); ?></div>
    </div>
    <div class="p-4 bg-purple-50 border border-purple-100 rounded-sm">
        ...
        <div class="text-2xl font-bold text-purple-900"><?php echo e($leads->where('referrer_id', auth()->id())->count()); ?></div>
    </div>
    <div class="p-4 bg-green-50 border border-green-100 rounded-sm">
        ...
        <div class="text-2xl font-bold text-green-900"><?php echo e(auth()->user()->teamMembers->count()); ?></div>
    </div>
</div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 transition-colors text-base">
                    ...
                    <td class="px-6 py-4 text-right">
                        <?php if($lead->user_id == auth()->id()): ?>
                            <button @click="editingLead = <?php echo \Illuminate\Support\Js::from($lead)->toHtml() ?>; leadView = 'form'" class="text-blue-500 mr-2"><i

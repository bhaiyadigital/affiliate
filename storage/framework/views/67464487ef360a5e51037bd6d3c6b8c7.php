...
<div x-data="{
    ...
    status: 'idle',
    errorMsg: '',
    fileId: '<?php echo e($fileId ?? ''); ?>',   // edit এ পুরনো value
...
>
    ...
    <input type="hidden" name="<?php echo e($fieldName ?? 'drive_file_id'); ?>" :value="fileId">
...
</div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\drive-upload.blade.php ENDPATH**/ ?>
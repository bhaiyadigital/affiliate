...
<div class="rounded-xl border border-gray-100 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
...
<?php endif; ?>
    ...
    <div class="border-gary-200 my-6 overflow-hidden rounded-xl border bg-gray-50 px-4 py-6 dark:border-gray-800 dark:bg-gray-900 sm:px-6">
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\components\ecommerce\customer-demographic.blade.php ENDPATH**/ ?>
...
<div class="overflow-hidden rounded-xl border border-gray-100 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
        <table class="min-w-full">
            ...
            <tbody>
                <?php $__currentLoopData = $productsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-500 text-theme-xs dark:text-gray-400">
                                        <?php echo e($product['variants']); ?> Variants
                                    </span>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($product['category']); ?></p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($product['price']); ?></p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
                            <span class="<?php echo e($getStatusClasses($product['status'])); ?>">
...
</div><?php /**PATH C:\laragon\www\affiliate\resources\views\components\ecommerce\recent-orders.blade.php ENDPATH**/ ?>
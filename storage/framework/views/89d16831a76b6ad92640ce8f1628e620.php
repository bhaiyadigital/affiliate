<?php $__env->startSection('content'); ?>
    <section class="container mx-auto px-6 py-12 font-['Outfit']">
        ...
        <?php else: ?>
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concernKey => $projects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-16">
                    <div class="flex items-center gap-4 mb-8">
                        <h2 class="text-2xl font-bold text-gray-800">
                            <?php echo e(\App\Models\Project::CONCERNS[$concernKey] ?? ucfirst(str_replace('_', ' ', $concernKey))); ?>
                        ...
                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white border border-gray-200 p-8 flex flex-col items-center justify-center text-center hover:shadow-md transition-all duration-300 group cursor-pointer h-full">
                                ...
                                <div class="h-24 w-full flex items-center justify-center mb-6">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('./images/brand/brand-01.svg')); ?>" alt="default"
...
<?php echo $__env->make('frontend.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\frontend\brandAsset.blade.php ENDPATH**/ ?>
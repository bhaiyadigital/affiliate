    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #e0e0e0;">
        ...
        <p>
            <?php if($purpose === 'register'): ?>
                Bhaiya Affiliate Program-এ রেজিস্ট্রেশন করার জন্য আপনাকে ধন্যবাদ। আপনার একাউন্ট ভেরিফাই করতে নিচের ওটিপি কোডটি ব্যবহার করুন:
            <?php else: ?>
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\frontend\auth\otp.blade.php ENDPATH**/ ?>
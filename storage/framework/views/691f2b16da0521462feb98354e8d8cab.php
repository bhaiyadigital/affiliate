...
<div class="p-4 mx-auto max-w-screen-md md:p-6">
    <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
        <a href="<?php echo e(route('asset-types.index')); ?>" class="hover:text-gray-700 dark:hover:text-gray-200 transition-colors">Asset Types</a>
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <form action="<?php echo e(route('asset-types.update', $assetType)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', $assetType->name)); ?>" required
                ...
                <div class="flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-700 pt-5">
                    <a href="<?php echo e(route('asset-types.index')); ?>" class="rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 transition-colors">
                        Cancel
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\asset-types\edit.blade.php ENDPATH**/ ?>
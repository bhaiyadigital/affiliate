...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-2 rounded-xl border border-gray-100 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                        <td class="px-5 py-4 whitespace-nowrap">
                            <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($type->name); ?></span>
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap text-end text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                
                                <a href="<?php echo e(route('asset-types.edit', $type)); ?>"
                ...
                url: '<?php echo e(route('asset-types.destroy', $type->id)); ?>', 
                title: '<?php echo e(addslashes($type->name)); ?>' 
            })"
            ...
            <?php echo $__env->make('partials.pagination', ['items' => $assetTypes], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\asset-types\index.blade.php ENDPATH**/ ?>
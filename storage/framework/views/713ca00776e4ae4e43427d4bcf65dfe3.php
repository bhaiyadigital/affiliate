...
<div class="p-4 mx-auto w-full  md:p-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2">
            ...
            <table class="w-full border border-gray-200 text-sm table mt-3">
                ...
                <tbody>
                    <?php $__currentLoopData = $campaign->downloadLogs->groupBy('user_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userId => $logs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\affiliate\resources\views\campaigns\show.blade.php ENDPATH**/ ?>
...
<section class="bg-gray-50 py-10">
    <div class="container mx-auto px-6 md:px-10">
        <div class="mb-16">
            ...
            <div id="filter-section" class="flex overflow-x-auto pb-4">
                <div class="flex gap-8 md:gap-12 whitespace-nowrap">
                    <a href="<?php echo e(route('affiliated.project')); ?>" aria-label="project route"
                        class="pb-3 font-bold text-sm md:text-base border-b-2 <?php echo e(!request('cat') && !request('dest') ? 'border-[#2c4294] text-gray-900' : 'border-transparent text-gray-700'); ?>">
                        All
                    </a>

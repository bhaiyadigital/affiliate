<div
    class="rounded-xl border border-gray-100 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
        ...
        <div class="flex items-start w-full gap-3 sm:justify-end">
            <div x-data="{ selected: 'overview' }"
                ...
                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button @click="selected = '<?php echo e($option['value']); ?>'"
                        :class="selected === '<?php echo e($option['value']); ?>' ?
...
<?php /**PATH C:\laragon\www\affiliate\resources\views\components\ecommerce\statistics-chart.blade.php ENDPATH**/ ?>
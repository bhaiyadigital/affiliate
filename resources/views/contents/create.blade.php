...
@section('content')
    <div class="p-4 mx-auto w-full md:p-6">
        ...
        <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
            <a href="{{ route('contents.index', $module) }}" class="hover:text-gray-700 capitalize">{{ $module }}
                List</a>
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
                    d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" />
            </svg>
            <span class="text-gray-700 dark:text-gray-300 font-medium">{{ isset($content) ? 'Edit' : 'Create' }}
                {{ ucfirst($module) }}</span>
        </nav>

        <form
            action="{{ isset($content) ? route('contents.update', [$module, $content->id]) : route('contents.store', $module) }}"
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div class="lg:col-span-8 space-y-6">
                    <div
                        ...
                        <h3 class="text-lg font-bold mb-5 text-gray-800 dark:text-white capitalize">{{ $module }}
                            Details</h3>

                        {{-- ইনপুট ফিল্ডগুলো এখান থেকে আসবে --}}
                        ...
                        <div
                            ...
                            <div class="mt-6 space-y-3">
                                <button type="submit"
                                    ...
                                    <i class="fas fa-save"></i> {{ isset($content) ? 'UPDATE' : 'SAVE' }} RECORD
                                </button>

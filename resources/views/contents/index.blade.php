...
<div class="p-4 mx-auto w-full md:p-6" x-data="{
    ...
    <div x-show="selected.length > 0" x-cloak
        ...
        <form id="bulk-form" action="{{ route('contents.bulk', $module) }}" method="POST" class="flex items-center gap-3">
            @csrf
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800" id="sortable-rows">
                    ...
                    <tr data-id="{{ $item->id }}" class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-5 py-4">
                            ...
                            @if ($module === 'coupons')
                            <span
                                class="text-sm font-medium text-gray-800 px-2 py-1 rounded">{{ $item->$field }}
                                times/user</span>
                            @else
                            <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span
                                    class="text-sm font-black text-blue-600">{{ $item->used_count }}</span>
                        ...
                        <td class="px-5 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                ...
                                <a href="{{ route('affiliated.project.details', $item->slug) }}" target="_blank"
                                    ...
                                    title="View">
                                    <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M10 3C5.5 3 1.7 5.9.6 10c1.1 4.1 4.9 7 9.4 7s8.3-2.9 9.4-7C18.3 5.9 14.5 3 10 3zm0 11.5a4.5 4.5 0 110-9 4.5 4.5 0 010 9z" />
                                ...
                                <form action="{{ route('contents.restore', [$module, $item->id]) }}"

        ...
        <div class="rounded-xl border border-gray-100 bg-white
            ...
            <div class="flex items-center justify-between border-b border-gray-100
                ...
                <span class="rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-semibold text-indigo-600">
                    {{ number_format($totalLeads) }} Total
                </span>
            </div>
        ...
        <div class="rounded-xl border border-gray-100 bg-white
            ...
            <div class="flex items-center justify-between border-b border-gray-100
                ...
                <span class="rounded-full bg-purple-50 px-2.5 py-1 text-xs font-semibold text-purple-600">
                    {{ number_format($manualLeads + $referralLeads) }} Leads
                </span>
            </div>
                ...
                <div>
                    ...
                    <div class="h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
                        <div
                            ...
                            style="width: {{ $totalLeads > 0 ? ($visitLeads / $totalLeads) * 100 : 0 }}%">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
                        <div
                            ...
                            style="width: {{ $totalLeads > 0 ? ($bookedLeads / $totalLeads) * 100 : 0 }}%">
                        </div>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5
            ...
            <div class="flex items-end justify-between mt-5">
                ...
                <a href="{{ route('contents.index', ['module' => 'project']) }}"

...
<header class="nav" id="mainNav" style="margin-top:30px;">
    <div class="wrap nav-inner">
        ...
        <nav class="nav-menu">
            ...
            @auth
                {{-- লগইন করা থাকলে মেনু --}}
                <a href="{{ route('landing.index') }}#refer" class="nav-item">রেফার জমা</a>
                <a href="{{ route('profile.index') }}" class="nav-item">ড্যাশবোর্ড</a>
            @else
                {{-- গেস্ট মোডে মেনু --}}
                <a href="{{ route('landing.index') }}#features" class="nav-item">কেন আমরা</a>
                <a href="{{ route('landing.index') }}#cta" class="nav-item">অভিজ্ঞতা</a>
                <a href="{{ route('landing.index') }}#refer" class="nav-item">রেফার জমা</a>
                <a href="{{ route('landing.index') }}#faq" class="nav-item">FAQ</a>
            @endauth
        </nav>
        ...
        <div class="nav-btns">
            ...
            @else
                {{-- গেস্ট মোডে লগইন ও জয়েন বাটন --}}
                <a href="{{ route('landing.index') }}#dashboard"
                    style="font-size:14.5px; font-weight:700; color:#0F172A; padding:10px 20px;">লগইন</a>
                <a href="{{ route('landing.index') }}#refer" class="btn-aiwave-primary">
                    যোগ দিন

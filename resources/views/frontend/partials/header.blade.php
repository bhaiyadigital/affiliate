                ...
                <div class="flex flex-col space-y-4 overflow-y-auto">
                    ...
                    <div class="pt-6 space-y-4">
                        ...
                        <a href="{{ route('bookmark.list') }}" class="flex items-center justify-between">
                            ...
                            @if($bookmarkCount > 0) <span class="bg-red-500 px-2 rounded-full text-xs">{{ $bookmarkCount }}</span> @endif
                        </a>

                        <a href="{{ route('tickets.index') }}" class="flex items-center gap-3"><i class="fa-regular fa-circle-question"></i> Help Center</a>

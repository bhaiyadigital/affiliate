    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="flex items-center gap-4 mb-8">
                <a href="{{ route('tickets.index') }}" class="text-[#0071c5] hover:opacity-70 transition-all">
                ...
                <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="6" required
                            ...
                            class="w-full border border-gray-300 px-4 py-3 text-sm outline-none focus:border-[#0071c5] transition-all bg-gray-50/30 resize-none">{{ old('description') }}</textarea>
                    </div>

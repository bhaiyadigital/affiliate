                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($tickets as $ticket)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-800">{{ $ticket->subject }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-500">{{ $ticket->replies_count }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-500">{{ $ticket->created_at->format('d M Y') }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-400 whitespace-nowrap">
                                    No tickets yet. <a href="{{ route('tickets.create') }}"
